...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = -1354310702L;
    ...
    public final com.example.haksikmokjang.community.post.domain.QPost post;
    ...
    public QComment(Class<? extends Comment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.post = inits.isInitialized("post") ? new com.example.haksikmokjang.community.post.domain.QPost(forProperty("post"), inits.get("post")) : null;
    }
